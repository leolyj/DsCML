...
from DsCML.common.config.base import CN, _C
...
_C.TRAIN.XMUDA.lambda_xm_global_src = 0.0
_C.TRAIN.XMUDA.lambda_xm_global_trg = 0.0
_C.TRAIN.XMUDA.lambda_pl = 0.0
_C.TRAIN.XMUDA.lambda_minent = 0.0
_C.TRAIN.XMUDA.lambda_logcoral = 0.0
_C.TRAIN.XMUDA.lambda_cc = 0.0
_C.TRAIN.XMUDA.D_adv_src_2d = 0.0
_C.TRAIN.XMUDA.D_adv_src_3d = 0.0
_C.TRAIN.XMUDA.D_adv_trg_2d = 0.0
_C.TRAIN.XMUDA.D_adv_trg_3d = 0.0
_C.TRAIN.XMUDA.G_adv_trg_2d = 0.0
_C.TRAIN.XMUDA.G_adv_trg_3d = 0.0
